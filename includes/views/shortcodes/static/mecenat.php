<thead class="subhead">
    <th colspan="4" rowspan="" headers="" scope="">MÉCÉNAT / PARTENARIAT / PERSONNALITÉS</th>
</thead>
            ...
            <table>
                <tbody>
                   <tr>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Françoise Bonnet</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td><img style="background-color: white;" title="Image du membre" alt="" src="http://fakeimg.pl/95x107" width="95" height="107"></td>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Jean-Claude Satta</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Relation avec les personnalités</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <td colspan="" rowspan="" headers="">
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Araëlle Adam</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Chargée de missions</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Clémentine Slembrouck</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
