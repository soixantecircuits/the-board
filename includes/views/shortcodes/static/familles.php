<thead class="subhead">
    <th colspan="4" rowspan="" headers="" scope="">ACCOMPAGNEMENT DES FAMILLES</th>
</thead>
        ...
        <td colspan="" rowspan="" headers="">
            <table>
                <tbody>
                   <tr>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Cindy Oger</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Responsable de l'Accompagnement des familles</p>
                        </td>
                    </tr>
                    <td>
            ...
            <td>
                <table>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Camille Lemaire</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Conseillère en économie sociale et familiale</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <tr>
                            <td>
                                <p class="nom"><strong>Anne Rousselot</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="fonction">Assistane sociale</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
