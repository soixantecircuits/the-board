<thead class="subhead">
    <th colspan="4" rowspan="" headers="" scope="">ADMINISTRATIF ET FINANCIER</th>
</thead>
            ...
            <table>
                <tbody>
                   <tr>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Delphine Pernot</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Responsable administratif et fincancier</p>
                        </td>
                    </tr>
                    <tr>
                        <td><img style="background-color: white;" title="Image du membre" alt="" src="http://fakeimg.pl/95x107" width="95" height="107"></td>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Josiane Eckmann</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Secrétaire comptable</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <tr>
                            <td>
                                <p class="nom"><strong>Christelle Ferry-Ladouceur</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="fonction">Assistane</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <td colspan="" rowspan="" headers="">
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Stéphanie Russo</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Assistane polyvalente</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p class="nom"><strong>Jean-Jacques Vigneront</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="fonction">Agent d'entretien polyvalent</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
