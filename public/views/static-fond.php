...
<table class="organigrame" style="width: 600px;"> 
    ...
    <tbody>
        <td colspan="" rowspan="10" headers="" style="border-right: 1px solid #5B717C; width:20%;">
            <table style="text-align: center;">
                <tbody style='text-align:center;'>
                    ...
                    <tr>
                        <td>
                            <p class="fonction">Directrice Adjointe PÔLE LEVÉE DE FONDS ET COMMUNICATION</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <td>
            <table style="text-align: center;">
                <thead class="subhead">
                    <th colspan="" rowspan="" headers="" scope="">MÉCÉNAT / PARTENARIAT / PERSONNALITÉS</th>
                </thead>
                <tbody style='text-align:center;'>
                    ...
                    <td colspan="" rowspan="" headers="" style="width:50%;">
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p class="nom"><strong>Pascal PRIN</strong></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
